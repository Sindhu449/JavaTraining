package com.Infinite.ServletsJdbc;
...
/**
 * Servlet implementation class EmploySarchServlet
 */
public class EmploySarchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmploySarchServlet() {
        super();
